...
| Packages/com.siki.gw2.protocol/ | Engine-independent protocol contracts and codecs (transport cipher, frame deframer + LZ4, schema decode/encode, direction-aware inbound/outbound codecs) |
