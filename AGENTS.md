...
- Keep research/imports immutable. Refresh by adding a new commit-named snapshot alongside the existing one; port reviewed semantics into runtime code separately.
