...
Inbound and outbound have different chains per id (msg-dispatch-addenda Addendum 26), so
...
def main():
    ...
    body = {
        ...
        "provenance": "Generated by tools/re/ExtractSchemaCorpus.py (msg-dispatch-addenda Addendum 8 offsets).",
        "messages": messages,
    }
