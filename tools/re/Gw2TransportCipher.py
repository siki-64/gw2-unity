#!/usr/bin/env python3
"""Reference transport stream cipher for build 205.780 (Gw2-64.exe).
...
Confidence and limits
  * The instruction-to-code mapping is recorded step by step in the note
    research/contracts/notes/Protocol/msg-dispatch-addenda.md (Addendum 9).
  * Validated against live traffic (msg-dispatch-addenda Addendum 16): the PRGA
...
Usage
  ...
  python tools/re/Gw2TransportCipher.py --emit-fixture tools/re/fixtures/205780/transport-cipher.json
"""
...
def build_fixture():
    ...
    body = {
        ...
        "provenance": "Generated by tools/re/Gw2TransportCipher.py from the "
                      "static reconstruction in msg-dispatch-addenda Addendum 9.",
