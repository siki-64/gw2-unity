...
Recovered statically from Gw2-64.exe (see msg-dispatch-addenda Addendum 23):
...
# Captured live (msg-dispatch-addenda Addendum 26): the game-connection seed and the
...
def emit_fixture(path):
    ...
    body = {
        ...
        "provenance": "Generated by tools/re/Gw2HandshakeKdf.py from the static "
                      "reconstruction in msg-dispatch-addenda Addendum 23.",
        "capturedVector": {
            "seed": CAPTURED_SEED,
            "outA20": CAPTURED_OUTA20,
            "provenance": "Live game connection, build 205.780 (msg-dispatch-addenda Addendum 26): "
